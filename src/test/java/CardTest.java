...
import cn.eiden.hsm.game.minion.minion.base.FreshwaterCrocodile;
import cn.eiden.hsm.game.minion.minion.base.LeperGnome;
...
import cn.eiden.hsm.game.minion.minion.base.druid.IronbarkProtector;
import cn.eiden.hsm.game.minion.minion.base.hunter.TimberWolf;
import cn.eiden.hsm.game.minion.minion.classic.BloodMageThalnos;
...
public class CardTest {
    ...
    public void testSwipeCard(){
        ...
        enemy.addMinion(new LeperGnome());
        enemy.getState();
        OutputInfo.info("===测试【血法】[横扫]，目标淡水鳄===");
        enemy.getState();
